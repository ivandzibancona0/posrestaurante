...
aplicacion.title("Punto de Venta - Restaurante")
...
# etiqueta titulo
etiqueta_titulo = Label(panel_superior, text='Restaurante Camarón', fg='#EAFAF1',
                        font=('Dosis', 48), bg='#148F77', width=32)
etiqueta_titulo.grid(row=0, column=0)

# panel izquierdo
panel_izquierdo = Frame(aplicacion, bd=1, relief=FLAT, bg='white')
panel_izquierdo.pack(side=LEFT)

# panel costos
panel_costos = Frame(panel_izquierdo, bd=1, relief=FLAT, bg='white', padx=50)
panel_costos.pack(side=BOTTOM)

# panel comidas
panel_comidas = LabelFrame(panel_izquierdo, text='COMIDAS', font=('Dosis', 19, 'bold'),
                           bd=1, relief=FLAT, fg='#148F77', bg='white')
...
# panel derecha
panel_derecha = Frame(aplicacion, bd=1, relief=FLAT, bg='white')
